...
<?php foreach ($list as $item): ?>
	<tr>
		...
		<td><?php echo $this->Html->link($item['Lining']['name'], array('action' => 'view', $item[$model_name]['id']));?></td>
		<td><?php echo $this->Html->image('/'.$item['LiningFabric']['Image']['path'].'/'.$item['LiningFabric']['Image']['name'], array('width' => 80, 'height' => 80)); ?></td>
