...
<div class="step-dark-left">完了</div>
...
<tr><td class="compTable"><p>登録が完了しました。</p></td></tr>
<tr><td class="compTable btnArea"><p><?php echo $this->Html->link($this->Html->image('/images/forms/btn_tolist.jpg'), array('action' => 'all'), array('escape' => false))?></p></td></tr>
</table>
<!-- end id-form  -->
